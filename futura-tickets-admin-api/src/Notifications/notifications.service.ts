...
export class NotificationService {
  ...
  public async createNotification(createNotification: CreateNotification): Promise<INotification> {
  ...
  public async getNotificationByOrderId(orderId: string, promoter: string): Promise<INotification | null> {
    return await this.notificationModel.findOne({ orderId, promoter }).populate({
      path: 'orderId',
      model: 'Orders',
      populate: [
        {
  ...
  public async getNotificationByClientId(userId: string, promoter: string): Promise<INotification | null> {
