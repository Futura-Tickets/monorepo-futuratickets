...
// import { InjectQueue } from '@nestjs/bull'; // Temporarily disabled - Bull/Redis not available
import { ConfigService } from '@nestjs/config';

// BULL
// import { Job, Queue } from 'bull'; // Temporarily disabled - Bull/Redis not available
...
export class MailService {
  ...
  constructor(
    ...
    // @InjectQueue('new-order-mail') private newOrderMailQueue: Queue, // Temporarily disabled - Bull/Redis not available
    // @InjectQueue('ticket-resale-mail') private ticketResaleQueue: Queue, // Temporarily disabled - Bull/Redis not available
    // @InjectQueue('ticket-sold-mail') private ticketSoldMailQueue: Queue, // Temporarily disabled - Bull/Redis not available
    // @InjectQueue('ticket-transfer-from-mail') // Temporarily disabled - Bull/Redis not available
    // private ticketTransferFromMailQueue: Queue, // Temporarily disabled - Bull/Redis not available
    // @InjectQueue('ticket-transfer-to-mail') // Temporarily disabled - Bull/Redis not available
    // private ticketTransferToMailQueue: Queue, // Temporarily disabled - Bull/Redis not available
    // @InjectQueue('ticket-invitation-to-mail') // Temporarily disabled - Bull/Redis not available
    // private ticketInvitationToMailQueue: Queue, // Temporarily disabled - Bull/Redis not available
    // @InjectQueue('new-account-mail') private newAccountMailQueue: Queue, // Temporarily disabled - Bull/Redis not available
    // @InjectQueue('recover-account-mail') private recoverAccountMailQueue: Queue, // Temporarily disabled - Bull/Redis not available
  ) {
      ...
      <html lang="en">
          ...
          <body>
              <table class="main">
                  <tr>
                    <td class="image">
                      <img src="${process.env.BLOB_URL}/${(order.event as unknown as Event).image}"/>
                    </td>
                  </tr>
                  <tr>
                      <td class="content">
                      ...
                      <td class="footer">
                          <table>
                              <td class="footer-item">
                                  <img src="${process.env.BLOB_URL}/futura-tickets-white.png"/>
                              </td>
      ...
      <html lang="en">
          ...
          <body>
              <table class="main">
                  <tr>
                      <td class="image">
                          <img src="${process.env.BLOB_URL}/${(sale.event as unknown as Event).image}"/>
                      </td>
                  </tr>
                  <tr>
                      <td class="content">
      ...
      <html lang="en">
          ...
          <body>
              <table class="main">
                  <tr>
                      <td class="image">
                          <img src="${process.env.BLOB_URL}/${(createdTicket.event as unknown as Event).image}"/>
                      </td>
                  </tr>
                  <tr>
                      <td class="content">
      ...
      <html lang="en">
          ...
          <body>
              <table class="main">
                  <tr>
                      <td class="image">
                          <img src="${process.env.BLOB_URL}/${transferFromEmail.event.image}"/>
                      </td>
                  </tr>
                  <tr>
                      <td class="content">
      ...
      <html lang="en">
          ...
          <body>
              <table class="main">
                  <tr>
                      <td class="image">
                        <img src="${process.env.BLOB_URL}/${transferToEmail.event.image}" style="width:100%"/>
                      </td>
                  </tr>
                  <tr>
                      <td class="content">
    ...
    const template = `
      <html>
        ...
        <body>
          ...
          <a href="${this.marketPlaceUrl}/recover-account?token=${registerToken}" style="font-size: 18px;>Recover account</a>
        </body>
      </html>`;
  ...
  // These methods would add jobs to Bull queues for async email processing
  // For now, emails can be sent directly using the sendXXX methods above

  // public async addNewOrderMailQueue(
  //   order: Order,
  // ): Promise<Job<{ order: Order }>> {
  //   return this.newOrderMailQueue.add({ order });
  // }

  // public async addTicketSoldMailQueue(
  //   createdTicket: CreatedTicket,
  //   account: Account,
  // ): Promise<Job<{ createdTicket: CreatedTicket; account: Account }>> {
  //   return this.ticketSoldMailQueue.add({ createdTicket, account });
  // }

  // public async addTicketTransferFromMailQueue(
  //   transferFromEmail: TransferFromEmail,
  // ): Promise<Job<{ transferFromEmail: TransferFromEmail }>> {
  //   return this.ticketTransferFromMailQueue.add({ transferFromEmail });
  // }

  // public async addTicketResaleMailQueue(
  //   sale: Sale,
  //   price: number,
  // ): Promise<Job<{ sale: Sale; price: number }>> {
  //   return this.ticketResaleQueue.add({ sale, price });
  // }

  // public async addTicketTransferToMailQueue(
  //   transferToEmail: TransferToEmail,
  // ): Promise<Job<{ transferToEmail: TransferToEmail }>> {
  //   return this.ticketTransferToMailQueue.add({ transferToEmail });
  // }

  // public async addTicketInvitationToMailQueue(
  //   order: Order,
  // ): Promise<Job<{ order: Order }>> {
  //   return this.ticketInvitationToMailQueue.add({ order });
  // }

  // public async addNewAccountConfirmationMailQueue({
  //   newAccount,
  //   password,
  // }: {
  //   newAccount: Account;
  //   password: string;
  // }): Promise<Job<{ newAccount: Account; password: string }>> {
  //   return this.newAccountMailQueue.add({ newAccount, password });
  // }

  // public async addRecoverAccountMailQueue(
  //   recoverAccount: Account,
  // ): Promise<Job<{ recoverAccount: Account }>> {
